...
public class JpaConfiguration {
    ...
    public LocalContainerEntityManagerFactoryBean entityManagerFactory(
        ...
        entityManagerFactory.setPackagesToScan(
                "ssgssak.ssgpointappevent.domain.drawingevent.entity",
                "ssgssak.ssgpointappevent.domain.eventlist.entity",
                "ssgssak.ssgpointappevent.domain.informationtypeevent.entity",
                "ssgssak.ssgpointappevent.domain.redirectionevent.entity");
        // JPA 벤더 어뎁터를 설정한다.
